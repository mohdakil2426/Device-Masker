...
- For Android 16 value checks, capture both the Device Masker config snapshot and `:verifier` `files/verifier/latest.json`; reports must compare expected vs actual values.
