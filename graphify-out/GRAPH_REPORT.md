...
## Corpus Check
- 263 files · ~198,841 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5404 nodes · 6397 edges · 491 communities (341 shown, 150 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 608 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `369bee11`
...
## Communities (491 total, 150 thin omitted)
...
Cohesion: 0.06
Nodes (39): 2026-05-03 Diagnostics And Root Export Audit Fixes, 2026-05-03 libxposed Audit Remediation, 2026-05-03 Maximum Diagnostics Logging, 2026-05-04 Implementation Verification Follow-up, 2026-05-04 Master Implementation Plan Completion, 2026-05-04 Navigation 3 Implementation, 2026-05-04 Startup Root And Boot Capture, 2026-05-06 Build Audit, R8 Enablement, and Docs Reorganization (+31 more)

### Community 13 - "Root Shell"
Cohesion: 0.06
Nodes (16): AntiDetectionTest, DiagnosticResult, DiagnosticsState, DiagnosticStatus, ReproCaptureState, DiagnosticsViewModel, DiagnosticsViewModelTest, AntiDetectionTest (+8 more)
...
Cohesion: 0.11
Nodes (12): AnimatedSection(), AntiDetectionSection(), AntiDetectionTestItem(), CategoryDiagnosticSection(), ConfigSyncInfoCard(), DiagnosticResultItem(), DiagnosticsContent(), DiagnosticsContentPreview() (+4 more)
...
Cohesion: 0.1
Nodes (17): BrowserPersona, DevicePersona, HardwarePersona, LocationPersona, NetworkEnvironmentPersona, parse(), parseOrNull(), SubscriptionPersona (+9 more)
...
Cohesion: 0.08
Nodes (25): 9A - Build And Install, 9B - Configure LSPosed Scope, 9C - Configure Device Masker, 9D - Force Stop And Launch Verifier, 9E - Pass-Through And Safety Tests, 9F - Existing App Smoke, 9G - Release/R8 Runtime Smoke, 9H - Reboot Validation (+17 more)
...
Cohesion: 0.17
Nodes (17): CategorySection(), LocationCategoryContent(), LocationSpoofItem(), SIMCardCategoryContent(), SimCarrierCard(), SimToggleHeader(), CorrelatedSpoofItem(), ExpressiveCard() (+9 more)
...
Cohesion: 0.13
Nodes (12): HomeScreen(), HomeScreenContent(), HomeScreenContentPreview(), HomeScreenInactivePreview(), ModuleEnableInstruction(), StatusBadge(), StatusCard(), StatusCardContent() (+4 more)

### Community 51 - "Fingerprint Generator"
Cohesion: 0.1
Nodes (12): AppMotion, Effect, MotionPolicy, Spatial, AppMotion, Effect, Effects, ElevationTokens (+4 more)
...
Cohesion: 0.1
Nodes (20): code:text (id: emulator-5554), code:powershell (.\gradlew.bat spotlessCheck detekt :common:testDebugUnitTest), code:powershell (.\gradlew.bat lint test assembleDebug assembleRelease :app:a), code:markdown (## Live Config Semantics), code:kotlin (val profileRestartRequired: Boolean), code:text (Profile changes require target force-stop/relaunch for Build), code:kotlin (val nativeMapsRedactionEnabled: Boolean = false,), code:text (Native maps redaction) (+12 more)

### Community 60 - "Settings Screen"
Cohesion: 0.1
Nodes (18): 2.2 Implementation Strengths, ✅ Adaptive Layout (MainActivity.kt:269-274), ✅ Animated Bottom Nav (BottomNavBar.kt:55-91), code:kotlin (val showNavRail = windowSizeClass.widthSizeClass != WindowWi), code:kotlin (@Serializable), code:kotlin (fun goBack(): Boolean {), code:kotlin ("groups" -> groupsDeepLink(segments)), code:kotlin (entryProvider {) (+10 more)
...
Cohesion: 0.18
Nodes (11): CompactGroupCard(), CompactGroupCardPreview(), DefaultBadge(), GroupActions(), GroupCard(), GroupCardFooter(), GroupCardHeader(), GroupIcon() (+3 more)
...
Cohesion: 0.12
Nodes (17): Build Commands, code:powershell (git tag v0.1.1), code:powershell (.\gradlew.bat spotlessApply spotlessCheck detekt :common:tes), code:powershell (.\gradlew.bat :xposed:testDebugUnitTest --no-daemon), code:powershell (.\gradlew.bat :app:testDebugUnitTest --tests com.astrixforge), code:powershell (powershell -ExecutionPolicy Bypass -File scripts\verify-16kb), code:powershell (adb install -r app\build\outputs\apk\debug\app-debug.apk), code:powershell (adb shell am force-stop com.mantle.verify) (+9 more)
...
Cohesion: 0.12
Nodes (17): code:kotlin (val presetId = getSpoofValue(prefs, pkg, SpoofType.DEVICE_PR), code:kotlin (val presetId = getConfiguredSpoofValue(prefs, pkg, SpoofType), code:kotlin (val group = config.getGroupForApp(packageName)), code:kotlin (val appEnabled =), code:kotlin (val appConfig = config.getAppConfig(packageName)), code:kotlin (prefs.edit {), code:kotlin (val ok = prefs.edit(commit = true) {), code:kotlin (try {) (+9 more)
...
Cohesion: 0.12
Nodes (17): code:kotlin (val group = config.getGroupForApp(packageName)), code:kotlin (val appEnabled =), code:kotlin (val appConfig = config.getAppConfig(packageName)), code:kotlin (prefs.edit {), code:kotlin (val ok = prefs.edit(commit = true) {), code:kotlin (/**), code:kotlin (private val initialized = AtomicBoolean(false)), code:kotlin (* - SubscriptionManager.getActiveSubscriptionInfoList() — mu) (+9 more)

### Community 90 - "IMEIGenerator"
Cohesion: 0.22
Nodes (12): EmptyState(), ExpressiveLoadingIndicatorWithLabel(), AppsList(), AppsSearchHeader(), AppsTabBody(), AppsTabContent(), AppsTabContentPopulatedPreview(), assignedGroupName() (+4 more)

### Community 91 - "MACGenerator"
Cohesion: 0.18
Nodes (11): AppsTabContent(), ExpressiveLoadingIndicator(), ExpressivePullToRefresh(), ExpressiveRefreshIndicator(), GroupSpoofingHeader(), GroupSpoofingPager(), GroupSpoofingScreen(), GroupSpoofingScreenContent() (+3 more)
...
Cohesion: 0.21
Nodes (10): SettingsDataStore, MotionPolicy, rememberMotionPolicy(), MainActivityContent(), RootAccessWarningDialog(), ApplyEdgeToEdgeStyle(), requestRootAndCaptureStartup(), RequestStartupRootCapture() (+2 more)

### Community 102 - "Diagnostic Session Manager"
Cohesion: 0.18
Nodes (8): MainActivity, DeviceMaskerMainApp(), handleShareLogsResult(), MainActivity, navBackTransform(), navForwardTransform(), NavRail(), SettingsEntry()

### Community 103 - "Diagnostic Snapshot Builder"
Cohesion: 0.21
Nodes (9): AppAssignmentControl(), AppDetails(), AppIcon(), AppIconFallback(), AppListItem(), AppListItemContent(), AppListItemLockedPreview(), appSubtitle() (+1 more)
...
Cohesion: 0.3
Nodes (11): CarrierDropdown(), CarrierDropdownButton(), CarrierDropdownItem(), CarrierInfoRows(), CarrierSelectorRow(), CountrySelectorButton(), CountrySelectorRow(), RegeneratableSimValues() (+3 more)
...
Cohesion: 0.29
Nodes (10): deterministicDigits(), calculateLuhnCheckDigit(), deterministicAlphaNumeric(), deterministicIccid(), deterministicImei(), deterministicImsi(), deterministicPhoneNumber(), deterministicSerial() (+2 more)
...
Cohesion: 0.18
Nodes (11): code:powershell (rg -n "\.intercept\s*\{|intercept\s*\{" xposed/src/main/kotl), code:kotlin (package com.astrixforge.devicemasker.xposed.hooker.callback), code:powershell (.\gradlew.bat :xposed:testDebugUnitTest --tests com.astrixfo), code:powershell (git add xposed/src/main/kotlin/com/astrixforge/devicemasker/), code:powershell (adb shell am force-stop com.mantle.verify), code:powershell (adb shell am force-stop com.mantle.verify), code:powershell (adb shell am force-stop com.mantle.verify), Current Callback Inventory (+3 more)
...
Cohesion: 0.18
Nodes (5): AppLogEntry, LogFileFormatter, PersistentAppLogTree, from(), LogFileFormatter
...
Cohesion: 0.33
Nodes (8): deterministicHex(), resolveLocation(), countryLocales(), countryTimezones(), generateBssid(), generateSsid(), gpsBoundsFor(), ssidWithHexPrefix()
...
Cohesion: 0.22
Nodes (9): code:powershell (.\gradlew.bat :app:testDebugUnitTest :xposed:testDebugUnitTe), code:powershell (git add common/src/main/aidl/com/astrixforge/devicemasker/ID), code:powershell (.\gradlew.bat :app:testDebugUnitTest --no-daemon), code:powershell (git add app/src/main/kotlin/com/astrixforge/devicemasker/ser), code:powershell (git add AGENTS.md memory-bank docs/reports/MAXIMUM_DIAGNOSTI), File Structure, Task 12: Documentation And AGENTS Update, Task 6: Diagnostics Service Structured Events (+1 more)
...
Cohesion: 0.33
Nodes (5): diagnosticsViewModelFactory(), groupSpoofingViewModelFactory(), groupsViewModelFactory(), homeViewModelFactory(), settingsViewModelFactory()
...
Cohesion: 0.33
Nodes (6): code:xml (<uses-permission android:name="android.permission.QUERY_ADVA), code:kotlin (package com.astrixforge.devicemasker.service.diagnostics), code:text (Identity Check is Android biometric/security policy state, n), code:powershell (.\gradlew.bat :app:testDebugUnitTest lint spotlessCheck dete), code:text (apiAvailable=false), Phase 5 - Android 16 Security Posture Diagnostics
...
Cohesion: 0.5
Nodes (4): code:kotlin (package com.astrixforge.devicemasker.xposed.hooker), code:powershell (.\gradlew.bat :xposed:testDebugUnitTest --tests com.astrixfo), code:powershell (git add xposed/src/test/kotlin/com/astrixforge/devicemasker/), Task 1: Add Static ABI Regression Tests
...
Cohesion: 0.67
Nodes (3): code:kotlin (/**), code:kotlin (private val initialized = AtomicBoolean(false)), Low 8: `XposedPrefs.init()` Claims Multiple Calls Are Safe But Has No Guard
...
## Knowledge Gaps
- **2090 isolated node(s):** `Keys`, `DashboardState`, `LogExportResult`, `ShareableLogResult`, `RootAccessState` (+2085 more)
...
- **Why does `DeviceMaskerMainApp()` connect `Diagnostic Session Manager` to `Implementation Plan Hardening Test`, `ILog Manager`, `IService Client`, `Action Bottom Sheet`, `Spoof Group`, `Community 204`, `Community 205`, `Root Shell`, `Diagnostics Screen`, `Hook Metrics`, `Diagnostic Redactor`, `Community 211`, `MACGenerator`, `Location Hooker`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `FakeSpoofRepository` connect `Activity` to `Expressive Loading Indicator`, `Community 211`, `Action Bottom Sheet`, `Settings State`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `HomeViewModel` connect `Community 211` to `Community 309`, `Community 349`, `Diagnostic Session Manager`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Are the 50 inferred relationships involving `StableHooker` (e.g. with `.hookAdvertisingIdClient()` and `.hookGservicesString()`) actually correct?**
  _`StableHooker` has 50 INFERRED edges - model-reasoned connections that need verification._
