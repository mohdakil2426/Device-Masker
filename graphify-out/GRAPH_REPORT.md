# Graph Report - devicemasker  (2026-05-08)

## Corpus Check
- 250 files · ~177,939 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4992 nodes · 5903 edges · 461 communities (316 shown, 145 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 590 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4723ef76`
...
1. `StableHooker` - 47 edges
2. `icon()` - 44 edges
3. `ConfigManager` - 33 edges
...
## Communities (461 total, 145 thin omitted)
...
Cohesion: 0.08
Nodes (21): AnimatedSection(), ModuleStatusCard(), moduleStatusDescription(), ModuleStatusIcon(), ModuleStatusText(), moduleStatusTitle(), AntiDetectionSection(), AntiDetectionTestItem() (+13 more)

### Community 10 - "Xposed Prefs"
Cohesion: 0.12
Nodes (29): CategoryContent(), CategoryHeader(), CategoryItems(), CategorySection(), CorrelatedCategoryActions(), displayValue(), isEnabledFor(), StandardCategoryItem() (+21 more)
...
Cohesion: 0.06
Nodes (37): 2026-05-03 Diagnostics And Root Export Audit Fixes, 2026-05-03 libxposed Audit Remediation, 2026-05-03 Maximum Diagnostics Logging, 2026-05-04 Implementation Verification Follow-up, 2026-05-04 Master Implementation Plan Completion, 2026-05-04 Navigation 3 Implementation, 2026-05-04 Startup Root And Boot Capture, 2026-05-06 Build Audit, R8 Enablement, and Docs Reorganization (+29 more)
...
Cohesion: 0.14
Nodes (12): ThemeModeDialog(), ExportActionsBottomSheet(), ExportActionsBottomSheetContent(), labelRes(), SettingsScreen(), SettingsScreenPreview(), exportResultMessage(), ExportResultSnackbarEffect() (+4 more)
...
Cohesion: 0.1
Nodes (18): 2.2 Implementation Strengths, ✅ Adaptive Layout (MainActivity.kt:269-274), ✅ Animated Bottom Nav (BottomNavBar.kt:55-91), code:kotlin (val showNavRail = windowSizeClass.widthSizeClass != WindowWi), code:kotlin (@Serializable), code:kotlin (fun goBack(): Boolean {), code:kotlin (entry<NavDestination.GroupSpoofing>(...) { destination ->), code:kotlin (entryProvider {) (+10 more)
...
Cohesion: 0.15
Nodes (11): HomeScreen(), HomeScreenContent(), HomeScreenContentPreview(), HomeScreenInactivePreview(), ModuleEnableInstruction(), StatusBadge(), StatusCard(), StatusCardContent() (+3 more)

### Community 53 - "App Scope Repository"
Cohesion: 0.18
Nodes (14): AppListItem(), AppListItemLockedPreview(), EmptyState(), InstalledApp, AppsList(), AppsSearchHeader(), AppsTabBody(), AppsTabContent() (+6 more)
...
Cohesion: 0.12
Nodes (13): HardwarePersona, NetworkEnvironmentPersona, parse(), parseOrNull(), PersonaValidationResult, SubscriptionPersona, TrackingPersona, validate() (+5 more)
...
Cohesion: 0.21
Nodes (12): CreateGroupDialog(), CreateGroupDialogPreview(), DeleteGroupDialog(), EditGroupDialog(), GroupsDialogs(), readGroupsJson(), rememberGroupsExportLauncher(), rememberGroupsImportLauncher() (+4 more)
...
Cohesion: 0.12
Nodes (16): code:kotlin (safeHook("TimeZone.getID()") {), code:kotlin (safeHook("Locale.toString()") {), code:kotlin (prefs.edit {), code:kotlin (val ok = prefs.edit(commit = true) {), code:kotlin (val ua = chain.args.firstOrNull() as? String ?: return@inter), code:kotlin (xi.hook(m).intercept { chain ->), code:kotlin (try {), code:kotlin (import io.github.libxposed.api.error.XposedFrameworkError) (+8 more)
...
Cohesion: 0.12
Nodes (16): code:kotlin (prefs.edit {), code:kotlin (val ok = prefs.edit(commit = true) {), code:kotlin (/**), code:kotlin (private val initialized = AtomicBoolean(false)), code:kotlin (* - SubscriptionManager.getActiveSubscriptionInfoList() — mu), code:kotlin (xi.hook(m).intercept { chain -> chain.proceed() }), code:kotlin (try {), code:kotlin (import io.github.libxposed.api.error.XposedFrameworkError) (+8 more)
...
Cohesion: 0.3
Nodes (12): SettingsScreenContent(), AboutSettingsSection(), AmoledModeSetting(), AppearanceSettingsSection(), DebugSettingsSection(), labelRes(), SettingsLoadingIndicator(), SettingsClickableItem() (+4 more)
...
Cohesion: 0.24
Nodes (4): ConfigSync, putAppDisabled(), putAppSyncState(), putSpoofTypeState()

### Community 96 - "Prefs Keys"
Cohesion: 0.27
Nodes (13): deterministicCoordinate(), deterministicDigits(), deterministicHex(), deterministicInt(), deterministicUuid(), digestBytes(), calculateLuhnCheckDigit(), deterministicAlphaNumeric() (+5 more)
...
Cohesion: 0.15
Nodes (9): QuickAction, QuickAction, QuickActionGroup(), QuickActionRow(), SelectionButtonGroup(), SelectionButtonGroupPreview(), QuickActionsSection(), QuickAction (+1 more)
...
Cohesion: 0.14
Nodes (13): Android R8 Keep Rule Guidance, code:text (java.lang.AbstractMethodError:), code:kotlin (xi.hook(method).intercept { chain ->), code:proguard (-keep interface io.github.libxposed.api.XposedInterface$Hook), Executive Summary, Final Recommendation, libxposed Hook ABI, LSPosed / libxposed Project State (+5 more)
...
Cohesion: 0.24
Nodes (5): appDiagnosticEvent(), AppLogStore, cleanLogField(), toAppLogSessionDir(), toDiagnosticSeverity()

### Community 115 - "Persona Generator Test"
Cohesion: 0.16
Nodes (9): DiagnosticEvent, DiagnosticEventType, DiagnosticSeverity, DiagnosticSource, DiagnosticEvent, DiagnosticEventType, DiagnosticSeverity, DiagnosticSource (+1 more)
...
Cohesion: 0.24
Nodes (9): AppsTabContent(), GroupSpoofingHeader(), GroupSpoofingPager(), GroupSpoofingScreen(), GroupSpoofingScreenContent(), GroupSpoofingTabs(), SpoofTabContent(), SpoofTabContent() (+1 more)
...
Cohesion: 0.15
Nodes (12): 8.1 Correlation Groups (Already Implemented), 8.2 Critical Correlations, 8.3 Validation (Already in Code), 8. Cross-Value Correlation Analysis, Appendix A: Standards References, Appendix B: TAC Resources, Appendix C: IEEE OUI Resources, Appendix D: Country Code Resources (+4 more)
...
Cohesion: 0.24
Nodes (9): DeviceHardwareUiState, DeviceProfileCard(), DeviceProfileDetails(), DeviceProfileDetailsRows(), DeviceProfileHeader(), DeviceProfileValueRow(), toDeviceHardwareUiState(), DeviceHardwareCategoryContent() (+1 more)
...
Cohesion: 0.17
Nodes (8): BrowserPersona, DevicePersona, LocationPersona, generate(), parseAndroidRelease(), BrowserPersona, DevicePersona, LocationPersona

### Community 139 - "Network Type Mapper"
Cohesion: 0.18
Nodes (5): pickFrom(), materializeGroup(), resolveCarrier(), resolvePreset(), deterministicMac()
...
Cohesion: 0.17
Nodes (12): code:powershell (rg -n "\.intercept\s*\{|intercept\s*\{" xposed/src/main/kotl), code:kotlin (* 3. Inside each [safeHook] block: resolve the [Method], cal), code:kotlin (* ```kotlin), code:powershell (.\gradlew.bat spotlessApply :xposed:testDebugUnitTest --no-d), code:powershell (git add xposed/src/main/kotlin/com/astrixforge/devicemasker/), code:powershell (.\gradlew.bat spotlessCheck :common:testDebugUnitTest :app:t), code:powershell (rg -n "\.intercept\s*\{|intercept\s*\{" xposed/src/main/kotl), code:powershell (.\gradlew.bat :xposed:testDebugUnitTest --tests com.astrixfo) (+4 more)
...
Cohesion: 0.27
Nodes (6): AppAssignmentControl(), AppDetails(), AppIcon(), AppIconFallback(), AppListItemContent(), appSubtitle()
...
Cohesion: 0.39
Nodes (8): EmptyGroupMenuItem(), GroupDropdownMenu(), GroupMenuItem(), GroupMenuState(), GroupMenuText(), GroupSelectorActions(), GroupSelectorHeader(), SelectedGroupText()
...
Cohesion: 0.33
Nodes (8): resolveLocation(), countryLocales(), countryTimezones(), generateBssid(), generateSsid(), gpsBoundsFor(), ssidWithDigitsPrefix(), ssidWithHexPrefix()
...
Cohesion: 0.32
Nodes (5): Snapshot, AppSyncState, keysForSyncedPackage(), SpoofTypeSyncState, syncStateFor()
...
Cohesion: 0.5
Nodes (4): 10.1 High Priority, 10.2 Medium Priority, 10.3 Low Priority, 10. Implementation Recommendations Summary
...
## Knowledge Gaps
- **1872 isolated node(s):** `Keys`, `DashboardState`, `LogExportResult`, `ShareableLogResult`, `RootAccessState` (+1867 more)
...
- **Why does `DeviceMaskerMainApp()` connect `Sensor Hooker` to `IConfig Manager`, `Community 199`, `Json Config`, `Support Bundle Builder`, `Root Shell`, `Settings State`, `App Log Store Test`, `Json Config Test`, `Fake Service Client`, `System Service Hooker`, `IMEIGenerator`, `Phone Number Generator`, `SIMGenerator`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `FakeSpoofRepository` connect `Home Screen` to `Jsonl Diagnostic Store Test`, `Status Indicator`, `Phone Number Generator`, `Settings State`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `icon()` connect `App Log Store` to `Diagnostics State Test`, `Xposed Prefs`, `Stat Card`, `Expressive Pull Refresh`, `Section Header`, `Apps Tab Content`, `Support Bundle Builder`, `Diagnostics State`, `Json Config Test`, `App Scope Repository`, `Typography`, `Community 199`, `Community 200`, `App Log Store Test`, `Fake App Scope Repository`, `Fake Service Client`, `MACGenerator`, `Community 227`, `Community 228`, `Action Bottom Sheet`, `Sensor Hooker`, `System Hooker`, `System Service Hooker`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 45 inferred relationships involving `StableHooker` (e.g. with `.hookAdvertisingIdClient()` and `.hookGservicesString()`) actually correct?**
  _`StableHooker` has 45 INFERRED edges - model-reasoned connections that need verification._
