 ...
 * 
 * Generates phone numbers matching the carrier's country,
 * ensuring consistency with IMSI and ICCID.
 * 
 * For USA: Uses realistic area codes from major states.
...
object PhoneNumberGenerator {
    ...
    /**
     * US area codes by state for realistic generation.
     * Selected high-population area codes from major states.
     */
    private val US_AREA_CODES = listOf(
        // California (most population)
        "213", "310", "323", "408", "415", "510", "619", "626", "650", "714", "818", "909", "949",
        // New York
        "212", "315", "347", "516", "518", "585", "607", "631", "646", "716", "718", "845", "914", "917", "929",
        // Texas
        "210", "214", "254", "281", "361", "409", "512", "682", "713", "817", "830", "903", "915", "972",
        // Florida
        "239", "305", "321", "352", "386", "407", "561", "727", "754", "786", "813", "850", "863", "904", "941", "954",
        // Illinois
        "217", "309", "312", "630", "708", "773", "815", "847",
        // Pennsylvania
        ...
        // Michigan
        "231", "248", "269", "313", "517", "586", "616", "734", "810", "989",
        // New Jersey
    ...
    /**
     * Digit counts for phone numbers by country code.
     * Excludes country code itself.
     */
    private val COUNTRY_PHONE_LENGTH = mapOf(
     ...
     * 
     * The phone number will match the carrier's country code,
     * ensuring consistency with IMSI and ICCID.
     * 
    ...
    private fun generateUSPhoneNumber(): String {
        ...
        val subscriber = buildString {
            repeat(4) { append(secureRandom.nextInt(10)) }
        }
    ...
    /**
     * Generates a Canadian phone number.
     * Uses common Canadian area codes.
     */
    private fun generateCanadianPhoneNumber(): String {
        val canadianAreaCodes = listOf(
            // Ontario
