 ...
 *
 * All values in a preset are consistent and should be applied together to create a realistic device
 * fingerprint.
 *
...
data class DeviceProfilePreset(
    ...
    companion object {
        /**
         * List of predefined device profiles. These are based on real device fingerprints from
         * stock ROMs.
         */
        val PRESETS =
            listOf(
