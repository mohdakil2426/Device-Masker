 ...
 * 
 * Timezone, locale, and GPS coordinates are all derived from the same country.
...
data class LocationProfile(
    ...
    companion object {
        ...
        /**
         * GPS coordinate bounds by country (minLat, maxLat, minLon, maxLon).
         * Major cities/populated areas for realism.
         */
         ...
         */
        private val COUNTRY_LOCALES = mapOf(
        ...
        fun generate(country: String? = null): LocationProfile {
            ...
            val (lat, lon) = if (gpsBounds != null) {
                val latitude = gpsBounds.minLat + (gpsBounds.maxLat - gpsBounds.minLat) * secureRandom.nextDouble()
                val longitude = gpsBounds.minLon + (gpsBounds.maxLon - gpsBounds.minLon) * secureRandom.nextDouble()
