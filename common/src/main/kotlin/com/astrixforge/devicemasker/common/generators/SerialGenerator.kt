...
object SerialGenerator {
    ...
    private fun generateSamsungSerial(): String {
        ...
        val serial = buildString {
            repeat(8) { append(secureRandom.nextInt(10)) }
        }
     ...
     * Format: 16 hex-like characters (uppercase)
     ...
     * Format: Typically 12-16 mixed alphanumeric
    ...
    /**
     * Generates a generic serial number for other manufacturers.
     * Format: 10-14 alphanumeric characters
