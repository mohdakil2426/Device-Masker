...
→ Ship JNI or bundled `.so` files: align ELF segments and Play 16 KB page-size checks per [migration.md → 16 KB memory page size](references/migration.md#16-kb-memory-page-size-play-and-native-code)  
