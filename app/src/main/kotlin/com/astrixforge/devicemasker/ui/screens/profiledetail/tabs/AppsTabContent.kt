package com.astrixforge.devicemasker.ui.screens.profiledetail.tabs
...
/**
 * Apps tab content for profile detail screen.
 *
 * Shows a searchable list of installed apps with toggles
 * to assign/unassign them from the current profile.
 */
@Composable
fun AppsTabContent(
    ...
    val filteredApps = remember(installedApps, searchQuery, profile) {
        installedApps
            .filter { app ->
        ...
        if (installedApps.isEmpty()) {
            ...
            LazyColumn(
                ...
                items(
                    ...
                    val assignedToOtherProfile = allProfiles
