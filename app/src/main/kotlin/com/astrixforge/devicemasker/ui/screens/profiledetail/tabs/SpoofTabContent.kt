...
import com.astrixforge.devicemasker.ui.screens.profiledetail.categories.CategorySection
import com.astrixforge.devicemasker.ui.screens.profiledetail.model.UIDisplayCategory
...
/**
 * Spoof Values tab content for profile detail screen.
 *
            ...
            if (profile != null) {
                ExpressiveCard(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(id = R.string.profile_detail_spoof_desc),
