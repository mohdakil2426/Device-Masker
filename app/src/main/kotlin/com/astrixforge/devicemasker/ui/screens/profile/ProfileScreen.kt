 ...
 *
 * @param viewModel The ProfileViewModel for state management
...
fun ProfileScreen(
    ...
    val exportLauncher = rememberLauncherForActivityResult(
        ...
        uri?.let {
            viewModel.exportProfiles { jsonData ->
                scope.launch {
            ...
            scope.launch {
                withContext(Dispatchers.IO) {
                    context.contentResolver.openInputStream(uri)?.use { inputStream ->
                        ...
                        viewModel.importProfiles(jsonData)
                    }
                }
            }
        }
    ...
    ProfileScreenContent(
        ...
        onSetDefault = { profile -> viewModel.setDefaultProfile(profile.id) },
        onEnableChange = { profile, enabled -> viewModel.setProfileEnabled(profile.id, enabled) },
        onExport = {
