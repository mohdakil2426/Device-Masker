 ...
 *
 * Each type represents a specific identifier that can be intercepted
 * and replaced with a spoofed value.
 */
enum class SpoofType(
    ...
    /**
     * Mobile Equipment Identifier - CDMA device identifier.
     * 14 digits, similar to IMEI.
     */
    MEID(
        displayName = "MEID",
        category = SpoofCategory.DEVICE,
     ...
     * Alphanumeric string, format varies by manufacturer.
     */
    SERIAL(
    ...
    /**
     * WiFi MAC address.
     * 48-bit address in XX:XX:XX:XX:XX:XX format.
     */
    WIFI_MAC(
    ...
    /**
     * Settings.Secure.ANDROID_ID - Per-app identifier.
     * 16 hex characters.
     */
    ANDROID_ID(
     ...
     * 16 hex characters, used by Google Play.
     */
    GSF_ID(
        displayName = "GSF ID",
        category = SpoofCategory.ADVERTISING,
     ...
     * UUID format, used for ad tracking.
     */
    ADVERTISING_ID(
