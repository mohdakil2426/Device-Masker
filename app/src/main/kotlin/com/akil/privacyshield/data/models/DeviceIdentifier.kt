 ...
 *
 * This data class holds both the spoof type and its current value,
 * along with metadata about modification state.
 *
...
data class DeviceIdentifier(
    ...
    /**
     * Returns a masked version of the value for display in UI.
    ...
    fun maskedValue(): String {
        ...
        val visibleCount = when (type) {
            SpoofType.IMEI, SpoofType.MEID, SpoofType.IMSI -> 4
            SpoofType.WIFI_MAC, SpoofType.BLUETOOTH_MAC -> 5
            SpoofType.ANDROID_ID, SpoofType.GSF_ID -> 4
