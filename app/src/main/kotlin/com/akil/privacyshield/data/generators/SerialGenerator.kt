package com.akil.privacyshield.data.generators
...
object SerialGenerator {
    ...
    /**
     * Characters used in serial number generation.
     * Excludes easily confused characters (I, O, Q).
     */
     ...
     */
    private val MANUFACTURER_PREFIXES = mapOf(
    ...
    fun generateForManufacturer(manufacturer: String): String {
        return when (manufacturer.lowercase()) {
            ...
            "google", "pixel" -> generateGoogleSerial()
            "xiaomi", "redmi" -> generateXiaomiSerial()
    ...
    /**
     * Generates a Google Pixel-style serial number.
     * Format: 3-letter prefix + 8-9 alphanumeric
     */
    private fun generateGoogleSerial(): String {
        val prefix = MANUFACTURER_PREFIXES["google"]?.random() ?: "HT7"
        val suffix = buildString {
            repeat(12 - prefix.length) {
                append(ALPHANUMERIC_CHARS.random())
            }
        }
        return prefix + suffix
     ...
     * Format: 2-letter prefix + 10-14 alphanumeric
     */
    ...
    /**
     * Generates a OnePlus-style serial number.
     * Format: 2-letter prefix + 10 alphanumeric
     */
    ...
    /**
     * Generates an Oppo-style serial number.
     * Format: 2-3 letter prefix + 9-11 alphanumeric
     */
    ...
    /**
     * Generates a Vivo-style serial number.
     * Format: 2-letter prefix + 10 alphanumeric
     */
