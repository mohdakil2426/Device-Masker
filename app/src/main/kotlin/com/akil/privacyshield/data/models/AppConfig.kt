 ...
 *
 * This data class defines which apps should have their device identifiers
 * spoofed and which profile/types to use for each app.
 *
...
data class AppConfig(
    ...
    /**
     * Checks if a specific spoof type is enabled for this app.
     * If enabledSpoofs is empty, all types are enabled by default.
     *
    ...
    /**
     * Returns the count of enabled spoof types.
     * If empty set (all enabled), returns total count.
     */
