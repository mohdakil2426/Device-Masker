...
object AntiDetectHooker : YukiBaseHooker() {
    ...
    private val HIDDEN_CLASS_PATTERNS =
            listOf(
                    ...
                    // REMOVED: "HookEntry", "PrivacyShield" to prevent module self-crash
                    "LSPosedService"
            )
    ...
    override fun onHook() {
        ...
        // ═══════════════════════════════════════════════════════════════
        val selfPackages = listOf("com.akil.privacyshield", "android", "system_server")
    ...
    private fun filterStackTrace(stack: Array<StackTraceElement>): Array<StackTraceElement> {
        return stack
                .filterNot { element ->
                    ...
                    if (className.startsWith("com.akil.privacyshield")) return@filterNot false
