...
import com.akil.privacyshield.ui.components.ProfileCard
                ...
                text = {
                        Column {
                                OutlinedTextField(
                                        ...
                                        placeholder = { Text("e.g., Samsung Galaxy S24") },
                                        singleLine = true,
...
private fun CreateProfileDialogPreview() {
        PrivacyShieldTheme { CreateProfileDialog(onDismiss = {}, onCreate = { _, _ -> }) }
}
