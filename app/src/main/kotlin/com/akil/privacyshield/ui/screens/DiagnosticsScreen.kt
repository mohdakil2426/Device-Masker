...
import com.akil.privacyshield.data.models.SpoofCategory
import com.akil.privacyshield.data.models.SpoofProfile
...
import com.akil.privacyshield.ui.theme.StatusActive
import com.akil.privacyshield.ui.theme.StatusInactive
import com.akil.privacyshield.ui.theme.StatusWarning
...
fun DiagnosticsScreen(
    ...
    DiagnosticsContent(
        isXposedActive = PrivacyShieldApp.isXposedModuleActive,
...
private fun ModuleStatusCard(
    ...
    ElevatedCard(
        ...
        colors = CardDefaults.elevatedCardColors(
            containerColor = if (isXposedActive) {
 ...
 */
@Composable
private fun AntiDetectionSection(
    tests: List<AntiDetectionTest>
) {
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column {
                        ...
                        Text(
                            ...
                            style = MaterialTheme.typography.bodySmall,
                            color = if (passedCount == tests.size) {
                                StatusActive
                            } else {
                                StatusWarning
                            }
 ...
 */
@Composable
private fun AntiDetectionTestItem(
    test: AntiDetectionTest
) {
    Row(
        modifier = Modifier.fillMaxWidth(),
        verticalAlignment = Alignment.CenterVertically
