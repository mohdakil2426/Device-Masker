...
fun AppSelectionScreen(
    ...
    // Filter apps: exclude system apps and PrivacyShield, then apply search/filter
    val filteredApps =
            remember(apps, searchQuery, activeFilter, enabledPackages) {
                apps.filter { app ->
                    ...
                    // Exclude PrivacyShield itself
                    if (app.packageName == "com.akil.privacyshield") return@filter false
